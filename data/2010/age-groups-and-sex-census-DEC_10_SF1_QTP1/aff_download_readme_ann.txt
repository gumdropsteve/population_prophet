...
This zip file contains a number of documents containing materials related to the table which you have downloaded.  
    These include: 
        ...
        3.  notes file
                >> DEC_10_SF1_QTP1.txt 
        4.  metadata file
                >> DEC_10_SF1_QTP1_metadata.csv

Naming convention:  
    > table file name
        >> based on Table Id 
    > For Geographic Comparison Tables (GCT) and Geographic Ranking Tables (GRT)
        >> table file name based on Table ID and Stub
...
Document descriptions:
    ...
    > Notes file:
        ...
        >> contains 
            > head notes
            > footnotes
            > description of cell annotations occurring in the data file 
    ...
    > Metadata file:        
        ...
        >> contains 
            > header information (transposed)
                >> without the data associated with the table
